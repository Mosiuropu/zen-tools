  ...
  return (
    <div className="max-w-4xl mx-auto space-y-12 animate-in fade-in duration-700">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-16 md:gap-24">
        {/* Digital Section */}
        <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-[3rem] p-10 md:p-16 shadow-2xl flex flex-col items-center justify-center space-y-4 min-w-[320px]">
          <div className="text-[10px] font-black uppercase tracking-[0.4em] text-slate-400">Current Time</div>
          <div className="text-6xl md:text-8xl font-black text-slate-900 dark:text-white tabular-nums tracking-tighter">
            {format(time, 'HH:mm')}
        ...
        <div className="flex flex-col items-center">
          {/* Clock Face */}
          <div className="relative w-64 h-64 md:w-80 md:h-80 bg-white dark:bg-slate-950 rounded-full border-8 border-slate-100 dark:border-slate-900 shadow-2xl flex items-center justify-center z-10">
            {/* Center Point */}
            <div className="absolute w-4 h-4 bg-blue-500 rounded-full z-40 shadow-lg" />
            
            {/* Hour Hand */}
            <div 
              className="absolute w-1.5 h-20 md:h-24 bg-slate-800 dark:bg-slate-200 rounded-full origin-bottom transition-all duration-300 ease-out"
          ...
          <div className="relative flex flex-col items-center mt-[-4px]">
            ...
            <div className="animate-zen-pendulum origin-top flex flex-col items-center">
               ...
               <div className="w-10 h-10 md:w-14 md:h-10 bg-slate-400 dark:bg-slate-800 rounded-full border-4 border-slate-100 dark:border-slate-900 shadow-xl flex items-center justify-center">
